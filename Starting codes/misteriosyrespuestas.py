# Conceptos básicos de Python para la creación de un descodificador de mensajes secretos
town = "Contosoville"
...
# Descodificación letra por letra con un cifrado César
# Python tiene una función denominada ord que convierte un carácter en su código de carácter ASCII correspondiente.
...
print(lasso_letter("N", 13))  # un error porque devuelve {
# Si el valor letter_code + shift_amount es igual o mayor que 123, debe volver a 97 para seguir contando.
# Para recorrer el alfabeto de forma sencilla, necesita un operador especial llamado mod, que es el signo de porcentaje (%). El operador mod divide dos números y devuelve el resto.
...
# Descodificación de una palabra completa con un cifrado César
...
# Result: April 4th in Contosoville
